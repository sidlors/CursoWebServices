 ...
 * 
 */
@WebServiceClient(name = "SayHelloService", targetNamespace = "http://service.practica1.certificatic.com.mx/", wsdlLocation = "file:/C:/Users/juanmanuel/PracticasWS/CursoWebServices/labs/student/exercises/Practica1/Practica1-Client/src/main/resources/SayHello.wsdl")
    ...
    extends Service
{
    ...
    private final static QName SAYHELLOSERVICE_QNAME = new QName("http://service.practica1.certificatic.com.mx/", "SayHelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/Users/juanmanuel/PracticasWS/CursoWebServices/labs/student/exercises/Practica1/Practica1-Client/src/main/resources/SayHello.wsdl");
    ...
    public SayHello getSayHelloPort() {
        return super.getPort(new QName("http://service.practica1.certificatic.com.mx/", "SayHelloPort"), SayHello.class);
    }
    ...
    public SayHello getSayHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.practica1.certificatic.com.mx/", "SayHelloPort"), SayHello.class, features);
    }
